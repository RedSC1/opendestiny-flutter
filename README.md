...
2.  📦 **[`bazi_core`](https://pub.dev/packages/bazi_core)** (v0.6.5)：八字逻辑库，处理农历转换、五行排盘及流运计算。
3.  📦 **[`ziwei_core`](https://pub.dev/packages/ziwei_core)** (v0.12.7)：紫微斗数规则库，负责星曜排布、星盘状态流变及四化演变。
